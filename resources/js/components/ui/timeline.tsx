...
export const Timeline = ({ data, title = "Cara Kerja IRTIQA", description = "Proses bimbingan yang terencana dan transparan untuk kenyamanan batin Anda." }: TimelineProps) => {
