...
export default function PackageCreate() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        description: '',
        type: 'session' as 'session' | 'period' | 'unlimited',
        sessions_count: '',
        duration_days: '',
        price: '',
        is_active: true,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 px-4 py-6">
                <div className="flex items-center justify-between">
                    <Heading title="Tambah Paket Baru" description="Buat paket konsultasi baru untuk pengguna" />
                ...
                <Alert>
                    ...
                    <AlertDescription>
                        Paket adalah layanan konsultasi yang dapat dibeli oleh pengguna. Anda dapat mengatur
                        paket berdasarkan jumlah sesi, periode waktu, atau tidak terbatas.
                    </AlertDescription>
                </Alert>
