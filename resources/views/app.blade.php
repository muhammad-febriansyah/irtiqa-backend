@php
    ...
    $seoTitle = SystemSetting::get('seo_title', $appName . ($tagline ? ' - ' . $tagline : ''));
    $seoDescription = SystemSetting::get('seo_description', SystemSetting::get('description', ''));
    $seoKeywords = SystemSetting::get('seo_keywords', '');
